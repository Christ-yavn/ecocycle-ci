        ...
        <div className="login-right-container">
          ...
          <div className="demo-section-mini mt-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <button className="py-2 px-3 bg-white border border-gray-200 rounded-lg hover:border-green-500 hover:text-green-700 transition" type="button" onClick={() => { setPhone('01 00 00 00 00'); setPassword('EcoLoop2026!'); }}>
                👑 Admin
              </button>
              <button className="py-2 px-3 bg-white border border-gray-200 rounded-lg hover:border-green-500 hover:text-green-700 transition" type="button" onClick={() => { setPhone('01 00 00 00 01'); setPassword('EcoLoop2026!'); }}>
                🛍️ Acheteur
              </button>
              <button className="py-2 px-3 bg-white border border-gray-200 rounded-lg hover:border-green-500 hover:text-green-700 transition" type="button" onClick={() => { setPhone('01 00 00 00 02'); setPassword('EcoLoop2026!'); }}>
                🏛️ Mairie Cocody
              </button>
              <button className="py-2 px-3 bg-white border border-gray-200 rounded-lg hover:border-green-500 hover:text-green-700 transition" type="button" onClick={() => { setPhone('01 00 00 00 04'); setPassword('EcoLoop2026!'); }}>
                🏭 Recycleur 1
              </button>
            </div>
          </div>
