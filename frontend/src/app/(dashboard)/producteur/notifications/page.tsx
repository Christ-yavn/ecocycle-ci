...
export default async function ProducteurNotificationsPage() {
  ...
  if (!user) {
    redirect("/login?redirect=/producteur/notifications");
  }
  ...
  return (
    <>
      <div className="pageHead">
        <h1>Notifications</h1>
        <p className="muted">
          Suivez l&apos;activité de vos lots et vos niveaux en temps réel.
        </p>
      </div>
