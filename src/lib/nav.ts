...
export const NAV: Record<Role, NavItem[]> = {
  producteur: [
    ...
    { href: "/producteur/signaler", label: "Signaler", icon: "alert" },
    { href: "/producteur/recompenses", label: "Récompenses", icon: "star" },
    { href: "/producteur/activite", label: "Activité", icon: "activity" },
  ],
  collecteur: [
    { href: "/collecteur", label: "Accueil", icon: "home" },
    { href: "/collecteur/missions", label: "Missions", icon: "truck" },
    { href: "/collecteur/carte", label: "Carte des gisements", icon: "map" },
  ...
  admin: [
    ...
    { href: "/admin/creer-compte", label: "Créer un compte", icon: "plus" },
